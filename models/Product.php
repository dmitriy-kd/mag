<?php
	...
	class Product
	{
		...
		public static function getRecommendedProducts()
		{
			...
			$result = $db->query('SELECT id, name, price, image, is_new FROM product WHERE is_recommended = "1" AND status = "1"');
			$result->setFetchMode(PDO::FETCH_ASSOC);
			$i = 0;
			while ($row = $result->fetch())
			{
		...
		public static function getImage($id)
		{
			...
			$pathProductImage = $path . $id . '.jpg';
			
			if(file_exists($_SERVER['DOCUMENT_ROOT'].$pathProductImage))
			{
